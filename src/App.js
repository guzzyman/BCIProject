...
const ROUTES = [
  ...
  {
    path: RouteEnum.RCA_REVIEWTEAM_ACKNOWLEDGEMENT,
    element: lazy(() => import("incident/RCAReviewTeamAcknowledgement")),
  },
  {
    path: RouteEnum.RCA_REVIEWTEAM_ACKNOWLEDGEMENT_OVERRIDE,
    element: lazy(() => import("incident/RCAReviewTeamAcknowledgement")),
  },
  {
    path: RouteEnum.RCA_REVIEW_MANAGER_ACKNOWLEDGEMENT,
    element: lazy(() => import("incident/RCAReviewManagerAcknowledgement")),
  },
  {
    path: RouteEnum.RCA_REVIEW_MANAGER_ACKNOWLEDGEMENT_OVERRIDE,
    element: lazy(() => import("incident/RCAReviewManagerAcknowledgement")),
  },
  {
    path: RouteEnum.RCA_REVIEWTEAM_MANAGEMENT,
    element: lazy(() => import("incident/RCAReviewTeamManagement")),
  },
  {
    path: RouteEnum.RCA_REVIEWMANAGER_MANAGEMENT,
    element: lazy(() => import("incident/RCAReviewTeamManagerManagement")),
  },
  {
  ...
  {
    path: RouteEnum.INCIDENT_FIVEWHYS_EDIT,
    element: lazy(() => import("fivewhys/IncidentFiveWhys")),
  },
  {
